...
class ChangePWview extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e){
		if (e.getSource()==okButton  ){
			if ( textPW1.getText()==textPW2.getText()){
...
class User_Account1 extends JFrame implements ActionListener{
	LoginView aLogin;
	ChangeIDview aIDchange;
	ChangePWview aPWchange;
...
*/	
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		User_Account1 account = new User_Account1();
